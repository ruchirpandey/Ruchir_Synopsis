...
\textbf{Objective:} It evaluates transient response to abrupt changes in both renewable sources as detailed in \ref{subsec:run5_combined}.
...
The follwoing five experimental runs validated different aspects of system behavior as in Table \ref{tab:test_campaign}:
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run1_M3_RotorCurrent1_INV.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run1_M4_Powers1_INV.png}
        \caption{Power measurements: $P_{rotor}$ , $P_{grid}$ , $P_{dc}$}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run2_M1_PSolar1_INV.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run2_M2_Powers1_INV.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth, height=8cm]{images/Run2_M3_RotorCurrent1_INV.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Run4_M1_Solar1_INV.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Run4_M2_Powers1_INV.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{images/Run4_M3_Rotor_Current1_INV.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run5_M1_Solar1_INV.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run5_M2_Powers1_INV.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/Run5_M3_RotorCurrent1_INV.png}
...
This section analyzes the dynamic response characteristics of all three controllers under the test scenarios defined in Section~\ref{sec:test_scenarios}, validating the DRL advantages (Chapter~\ref{chap:literature}) and TD3 innovations (Section~\ref{subsec:td3_motivation}).
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{images/Run4_M1_Solar1_INV.png}
    \caption{System response to solar PV current step}
    \label{fig:pv_step}
\end{figure}
...
TD3's superior performance stems from conservative value estimation via clipped double Q-learning preventing aggressive overshoots, and target policy smoothing ensuring smoother control trajectories.
...
Superior GSC performance relates to system architecture (Chapter~\ref{chap:model}): PV-DC link integration creates coupled dynamics (Equation~\ref{eq:vdc_dot}) requiring coordinated management of all power flows. The unified control approach manages interactions holistically, with learning-based optimization (Section~\ref{subsec:training_infrastructure}) enabling TD3 to discover optimal coordination without explicit mathematical models.
