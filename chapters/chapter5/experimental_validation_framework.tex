...
\textcolor{red}{--------------TBD---------------}
\\
\textbf{\textit{TBD add definition of legends CHA1 CH2 ETC}}
\\
\textbf{\textit{S0LAR CURRENT UNIFIED VALUE 50A TO 5A}}
\\
\textbf{\textit{COMPARSION TABLE FOR RESULTS TOHAVE RUN4 ONLY}}
\\
\\
\textbf{\textit{LAST CHAPTER REVIEW ALL BOL AND ITALICIZED TEXT }}
\\
\textcolor{red}{--------------TBD---------------}
