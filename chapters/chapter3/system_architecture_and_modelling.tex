...
\begin{figure}[htbp]
    ...
    \caption{System architecture of DFIG-Solar PV hybrid system with DRL-based unified controller}
...
\begin{figure}[htbp]
    ...
    \caption{TD3-based system architecture with twin critic networks}
