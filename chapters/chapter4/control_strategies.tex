...
\begin{enumerate}
    ...
    \item \textbf{Low reward variance:} The stable reward trajectory demonstrates that target policy smoothing effectively regularises the policy(\ref{eq:target_smoothing}).
